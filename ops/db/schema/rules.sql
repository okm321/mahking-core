...
CREATE TABLE rules (
  ...
  fractional_calculation integer NOT NULL DEFAULT 1 CHECK (fractional_calculation IN (1, 2, 3, 4, 5)),
  ...
  CONSTRAINT chk_fractional_recipient CHECK (
...
COMMENT ON COLUMN rules.fractional_calculation IS '1: 小数点有効, 2: 切り捨て, 3: 切り上げ, 4: 四捨五入, 5: 五捨六入';
